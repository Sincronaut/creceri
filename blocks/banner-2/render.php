  ...
  <div class="hero__inner">
    <div class="hero__copy">
      ...
      <?php if (!empty($line_html)) : ?>
        <h2 class="hero__line"><?php echo $line_html; ?></h2>
      <?php endif; ?>
    ...
    <div class="hero__art"><br>
      <picture>
        <img
          class="hero__image"
          style="margin-top:<?php echo esc_attr($margin_top); ?> !important;padding-right:<?php echo esc_attr($margin_right); ?>  !important;padding-bottom:<?php echo esc_attr($margin_bottom); ?> !important;"
          src="<?php echo esc_url($img_src); ?>"
          alt="<?php echo esc_attr($img_alt); ?>"
          <?php if ($img_w) : ?>width="<?php echo intval($img_w); ?>"<?php endif; ?>
          <?php if ($img_h) : ?>height="<?php echo intval($img_h); ?>"<?php endif; ?>
