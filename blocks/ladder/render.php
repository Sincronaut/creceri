...
<section id="<?php echo esc_attr($section_id); ?>"
  ...
  if (trim($heading) === '' && empty($bullets)) {
    continue;
  }
?>
        <details class="bc-acc" <?php echo $open ? 'open' : ''; ?> role="listitem">
          <summary><h3 class="bc-acc__title"><?php echo esc_html($heading); ?></h3></summary>
          <div class="bc-acc__panel">
            <div class="bc-acc__panel-inner">
...
?>
                    <li>
                      <?php if ($bt): ?><strong><?php echo esc_html($bt); ?></strong><?php
      endif; ?>
                      <?php if ($bd): ?> &ndash; <?php echo $bd; ?><?php
      endif; ?>
                    </li>
                  <?php
    endforeach; ?>
              ...
              <?php if ($ctaLabel && $ctaUrl): ?>
                <a class="btn btn-pill" href="<?php echo $ctaUrl; ?>"><?php echo esc_html($ctaLabel); ?></a>
              <?php
  endif; ?>
            </div>
          </div>
